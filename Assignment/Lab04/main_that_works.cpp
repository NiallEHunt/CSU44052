...
#define OBJECT_MESH_NAME "models/ground.obj"
...
GLuint ground_VAO, monkey_face_VAO;
...
void generateObjectBufferMesh(GLuint vao, const char* mesh_name) {
	/*----------------------------------------------------------------------------
...
void display() {
	...
	model = translate(model, vec3(pos_x, pos_y, pos_z));
	
	view = translate(view, vec3(0.0, -10.0f, -100.0f));
...
void init()
{
	...
	Model local_ground (GROUND_MESH_NAME, vec3(0.0f, 0.0f, 0.0f));
	ground = local_ground;

	// load mesh into a vertex buffer array
	generateObjectBufferMesh(ground_VAO, GROUND_MESH_NAME);

	generateObjectBufferMesh(monkey_face_VAO, OBJECT_MESH_NAME);
}
